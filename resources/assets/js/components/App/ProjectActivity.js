...
import projectDataTypeMap from './constants/projectDataTypeMap'
...
export default class ProjectActivity extends Component {
  ...
  addToActivityList = (typeBeingAdded) => {
    ...
    const typeSettings = _.cloneDeep(projectDataTypeMap[typeBeingAdded]) // Get the settings for the current type being added
      ...
      <ProjectContentContainer 
        ...
        {this.activityList().map((timelineItem, index) => {
          ...
          return React.createElement(
            projectDataTypeMap[type].component,
            {
              key: index,
              id: id,
              data: data,
